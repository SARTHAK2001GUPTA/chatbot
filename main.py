...
try:    # Optional for style, importing pyfiglet module
    ...
    print(f.renderText('Friends Sweet House'))
...
def get_name(shop_name = 'Friends Sweet Houses'):
...
def order2(shop_name = 'Friends Sweet Houses'):  # For ordering different types of items.
    print('')
